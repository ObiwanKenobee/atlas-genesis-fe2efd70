  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg">Portfolio Performance & Allocation Trends</h3>
          <div className="flex items-center gap-2 text-sm">
            <button className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded hover:bg-emerald-200 transition-colors">
              6M
            </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Asset Allocation */}
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          <h3 className="text-lg mb-4">Asset Allocation</h3>
        ...
        {/* Impact ROI Summary */}
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          <h3 className="text-lg mb-4">Impact ROI Summary</h3>
      ...
      {/* Recent Allocations */}
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
        <h3 className="text-lg mb-4">Recent Regenerative Allocations</h3>
      ...
      {/* Liquidity Pools */}
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
        <h3 className="text-lg mb-4">Active Liquidity Pools</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {liquidityPools.map((pool, idx) => (
            ...
            >
              ...
              <button className="mt-3 w-full px-3 py-2 text-xs bg-emerald-600 text-white hover:bg-emerald-700 rounded transition-colors">
                Add Liquidity
              </button>
            </div>
          ))}
